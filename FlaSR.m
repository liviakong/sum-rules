...
Print[FilterRules[{opts},Options[printSRs]]];
Print[DeleteCases[FilterRules[{opts},Options[printSRs]],amp2Type->_]];
Print[DeleteCases[FilterRules[{opts},Options[printSRs]],FlaSR`Private`amp2Type->_]];
